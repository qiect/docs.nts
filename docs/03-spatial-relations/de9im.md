...
- [PreparedGeometry](../06-performance/prepared-geometry.md)：同一几何多次谓词判定的性能优化
- [空间索引 STRtree](../06-performance/spatial-index.md)：批量谓词查询的加速结构
- [几何属性](../02-geometry-fundamentals/geometry-properties.md)：几何自身的 interior/boundary/exterior 与度量
