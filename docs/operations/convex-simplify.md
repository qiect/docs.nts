...
- [空间谓词](../predicates/relationships.md)：用简化后的几何做关系判断
- [测量与距离](../analysis/measurement.md)：评估简化对长度/面积的影响
- [PreparedGeometry](../advanced/prepared-geometry.md)：简化后重复查询的加速
- [API 速查表](../cookbook/cheatsheet.md)：所有操作的快速复制粘贴模板
