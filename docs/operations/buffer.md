...
- [空间谓词](../predicates/relationships.md)：用缓冲做距离判断的反模式、正确姿势
- [预构建几何 PreparedGeometry](../advanced/prepared-geometry.md)：批量 `Covers` / `Intersects` 加速
- [API 速查表](../cookbook/cheatsheet.md)：所有几何运算一览
