...
更多 WKT 细节见 [WKT 与 WKB](../02-geometry-fundamentals/wkt-wkb.md)。
...
- [坐标与几何层级](../02-geometry-fundamentals/geometry-hierarchy.md)：理解完整的类型继承树
- [几何工厂 GeometryFactory](../02-geometry-fundamentals/geometry-factory.md)：工厂的更多用法
- [WKT 与 WKB](../02-geometry-fundamentals/wkt-wkb.md)：文本与二进制序列化格式
